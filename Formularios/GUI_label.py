...
class Label(Widget):
    def __init__(self, screen, x, y, w, h, text, font,font_size,font_color,path_image) -> None:
        ...
        # else:
            ...
            # aux_image.set_alpha(0)#trasnparente
    ...
    def render(self):
        ...
        media_texto_horzontal = image_text.get_width() / 2 
        media_texto_vertical = image_text.get_height() / 2 

        media_horzontal = self._w / 2 
        media_vertical = self._x / 2 

        diferecia_horizontal = media_horzontal - media_texto_horzontal
        diferecia_vertical = media_vertical - media_texto_vertical

        self._slave.blit(image_text,(diferecia_horizontal,diferecia_vertical))
