...
class Button(Widget):
    def __init__(self, screen,master_x,master_y, x, y, w, h, color_background, color_border,onclick,onclick_param,text,font,font_size,font_color) -> None:
    ...
    def render(self):
        ...
        self._slave = pygame.surface.Surface((self._w,self._h))#superfici que se adapta
        ...
        diferencia_veretical = media_vertical - media_texto_vertical

        self._slave.blit(image_text,(diferencia_horizontal,diferencia_veretical))
