...
class Button_Image(Widget):
    def __init__(self, screen,master_x,master_y, x, y, w, h,path_image,onclick=None,onclick_param=None,text="",font="Arial",font_size=12,font_color="Black", color_background=None, color_border="Black", border_size=-1) -> None:
